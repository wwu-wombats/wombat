...
<body>
    ...
    <script id="decryptworker" type="javascript/worker">
        ...
        self.onmessage = function(e) {
            var recv = JSON.parse(e.data);
            var decrypted = CryptoJS.AES.decrypt(recv.payload, recv.secretkey, {
                mode: CryptoJS.mode.ECB
            });
            var data = JSON.stringify({payload: decrypted.toString(CryptoJS.enc.Utf8)});
            self.postMessage(data);
        }
    </script>
</body>
